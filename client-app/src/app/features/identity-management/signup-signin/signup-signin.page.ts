...
export class SignupSigninPage extends BaseIdentityService implements OnInit, OnDestroy {
  ...
  //description = `Join Varsity Sports Academy™ to build your recruiting profile, improve performance, and get
...
`.trim();  
  ...
  ngOnInit(): void{
    ...
    this.title.setTitle('Why Join Varsity Sports Academy™ | Recruiting, Training & Exposure');
    this.meta.updateTag({ name: 'description', content: 'Membership at Varsity Sports Academy™ unlocks personalized recruiting plans, performance training, and real exposure through showcases, camps, and combines.' });
    this.meta.updateTag({ name: 'robots', content: 'index,follow' });
    this.meta.updateTag({ property: 'og:title', content: 'Varsity Sports Academy™ Membership' });
    ...
    this.meta.updateTag({ property: 'og:image', content: '/assets/img/og/vsaprep-membership.jpg' });
    this.meta.updateTag({ property: 'og:url', content: 'https://your-domain.com/membership' });
    this.meta.updateTag({ name: 'twitter:card', content: 'summary_large_image' });
    this.meta.updateTag({ name: 'twitter:title', content: 'Varsity Sports Academy™ Membership' });
    this.meta.updateTag({ name: 'twitter:description', content: 'Recruiting, training & exposure for student-athletes.' });
    this.meta.updateTag({ name: 'twitter:image', content: '/assets/img/og/vsaprep-membership.jpg' });
  ...
  private webPageJsonLd() {
    return {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Why Join Varsity Sports Academy",
  ...
  private faqJsonLd() {
    return {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Who should join Varsity Sports Academy?",
          "acceptedAnswer": {
            "@type": "Answer",
