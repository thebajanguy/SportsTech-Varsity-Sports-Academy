...
@Component({
    ...
    imports: [CommonModule, NgbModule, AngularMultiSelectModule, FormsModule, SocialPluginComponent, NewsletterPage],
...
export class ApproachPage implements OnInit, OnDestroy, AfterViewInit  {
    data : Date = new Date();
