...
export class ConsultationPage  extends BasePageComponent {
  ...
  form = this.fb.group({
    ...
    Phone: this.fb.nonNullable.control<string>('', { validators: [Validators.required, this.stringValidator(), Validators.minLength(10), Validators.maxLength(20)] }),
